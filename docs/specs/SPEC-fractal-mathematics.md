...
8. **Penta 1**: $(C\#, D\#, F\#, G\#, A\#)$ — steps: $2, 3, 2, 2, 3$
9. **Penta 2**: $(D\#, F\#, G\#, A\#, C\#)$ — steps: $3, 2, 2, 3, 2$
10. **Penta 3**: $(F\#, G\#, A\#, C\#, D\#)$ — steps: $2, 2, 3, 2, 3$
11. **Penta 4**: $(G\#, A\#, C\#, D\#, F\#)$ — steps: $2, 3, 2, 3, 2$
12. **Penta 5**: $(A\#, C\#, D\#, F\#, G\#)$ — steps: $3, 2, 3, 2, 2$
...
The Fibonacci series $F = [1, 2, 3, 5, 8, \dots]$ acts as the logarithmic growth scale for interval spacing.
